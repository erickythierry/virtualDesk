...
RUN set -ex;\
    ...
    apt-get install git tightvncserver expect websockify qemu-system-x86 xubuntu-core^ xfce4 dbus-x11 xorg x11-xserver-utils zip git thunar-archive-plugin firefox -y
ENV DISPLAY=:0
